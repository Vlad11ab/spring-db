...
//        Optional<UserResponse> expected = Optional.of(new UserResponse(2L, "Andrei", "Popescu", "andrei.popescu@gmail.com", 25, LocalDate.now(), "0721123456", copyPermissions(user.getPermissions()), "parola123"));
