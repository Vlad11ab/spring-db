...
//
//import static com.example.springdb.mappers.UserMapper.copyPermissions;
...
//    UserResponse userResponse1 = new UserResponse(2L, "Andrei", "Popescu", "andrei.popescu@gmail.com", 25, LocalDate.now(), "0721123456", copyPermissions(user.getPermissions()), "parola123");
//    UserResponse userResponse2 = new UserResponse(3L, "Maria", "Ionescu", "maria.ionescu@gmail.com", 28, LocalDate.now(), "0732456789", copyPermissions(user.getPermissions()), "securePass");
//    UserResponse userResponse3 = new UserResponse(4L, "Alex", "Georgescu", "alex.georgescu@gmail.com", 31, LocalDate.now(), "0743987654", copyPermissions(user.getPermissions()), "alexPass");
//    UserResponse userResponse4 = new UserResponse(5L, "Elena", "Dumitrescu", "elena.dumitrescu@gmail.com", 24, LocalDate.now(), "0755123987", copyPermissions(user.getPermissions()), "elenaPwd");
//    UserResponse userResponse5 = new UserResponse(6L, "Radu", "Stan", "radu.stan@gmail.com", 29, LocalDate.now(), "0766234567", copyPermissions(user.getPermissions()), "raduPass");
//
//
//
//
...
//        UserResponse userResponse = new UserResponse(2L, "Andrei", "Popescu", "andrei.popescu@gmail.com", 25, LocalDate.now(), "0721123456", copyPermissions(user.getPermissions()), "parola123");
//
...
//        UserResponse userResponse = new UserResponse(3L, "Radu", "Stan", "breazuvlad@gmail.com", 22, LocalDate.now(), "073827210", copyPermissions(user.getPermissions()), "parola");
//
