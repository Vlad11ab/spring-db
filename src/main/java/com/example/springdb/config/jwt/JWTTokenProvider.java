package com.example.springdb.config.jwt;
...
import static com.example.springdb.config.security.SecurityConstants.*;
...
public class JWTTokenProvider {
    ...
    public String generateToken(UserDetails user){
        ...
        return Jwts.builder()
                ...
                .expiration(new Date(System.currentTimeMillis() + tokenExpirationDate * 24 * 60 * 60 * 1000))
